...
const Hero = () => {
  return (
    <div className="px-4 md:px-24 py-10 text-[#61615d] bg-[#fdfdfd]">
      <span className="flex flex-row text-xs uppercase gap-1 mb-10">
...
const Why = () => {
  return (
    <div className="">
      <div className="mt-16 pb-20 px-4 md:px-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 px-4 md:px-24 pb-24">
        <div>
          <video src="https://fast.wistia.com/embed/medias/9dqe6nrt8z.jsonp"></video>
        </div>
        <div className="">
          <ul className="flex flex-col gap-2.5 items-start pb-6">
            <li className="flex flex-row gap-2 items-center justify-start">
              <p className="bg-[#6bbf4f] text-center border-[#6bbf4f] p-1 w-fit rounded-full">
      ...
      <div className="bg-[#f5f6f8] relative px-4 md:pl-24 grid grid-cols-1 md:grid-cols-6 gap-14">
        ...
        <div className="md:col-span-3 py-8">
          <div className="bg-[#6bbf4f] relative w-[100%] h-[100%] pl-8 py-2">
            <span className="absolute top-[-1.2rem]">
              <img
                className="w-[12rem]"
            ...
            <span className="absolute w-[8rem] shadow-lg bg-white py-8 bottom-1 left-36 flex items-center justify-center z-50">
              <img
                className=" w-[5rem]"
...
const Started = () => {
  return (
    <div className="px-4 md:px-24 place-items-center py-20 grid grid-cols-1 md:grid-cols-6 gap-8">
      ...
      <div className="md:col-span-4">
        ...
        <p className="underline cursor-pointer text-lg">Get the playbook</p>
      </div>
    </div>
  );
};
...
const Grow = () => {
  return (
    <div className="px-4 md:px-24 bg-[#363f44] text-white py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-6">
        <div className="">
          ...
          <p className="text-sm mb-2">
            Simplify your multi-tenant management routine with new subaccount
            role and access tagging features in the Duo Admin Panel—improving
            efficiency without compromising security.
          </p>
          <p className="underline text-sm mb-1 cursor-pointer">
            {" "}
        ...
        <div>
          ...
          <p className="text-lg font-semibold mb-2">Knowledge base</p>
          <p className="text-sm mb-2">
            Quickly find the support you need to resolve your issue, with
            helpful documentation and relevant articles. Plus, you can view your
            support cases or create a new case.
          </p>
          <p className="underline text-sm cursor-pointer">
        ...
        <div>
          ...
          <p className="text-lg font-semibold mb-2">Secure MSP Center </p>
          <p className="text-sm mb-2">
            Interested in selling other SaaS-security products? Check out Secure
            MSP Center, our direct buying model for Umbrella and Secure Endpoint
            modelled after the success of the Duo Managed Service Provider
            program.{" "}
          </p>
          <p className="underline text-sm cursor-pointer">
        ...
        <div>
          ...
          <p className="text-lg font-semibold mb-2">Duo documentation</p>
          <p className="text-sm mb-2">
            Duo supports a wide range of devices and applications. Visit this
            page for detailed documentation, installation, and configuration
            information.{" "}
          </p>
          <p className="underline text-sm cursor-pointer">
            Get expert guidance{" "}
        ...
        <div>
          ...
          <p className="text-sm mb-2">
            No matter the sale, we’ve got the materials to help you sell Duo,
            including training materials, collateral, and sales enablement
            resources.{" "}
          </p>
          <p className="underline text-sm cursor-pointer">
    ...
    <div className="px-4 md:px-24 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="">
          ...
          <p className="underline mb-3 leading-5.5 cursor-pointer text-[#5b6063] text-sm">
            {" "}
          ...
          <p className="underline cursor-pointer text-[#5b6063] text-sm">
            Read more
          </p>
        </div>
        ...
        <div>
          ...
          <p className="underline cursor-pointer mb-3 leading-5.5 text-[#5b6063] text-sm">
            Duo MSP Tech Talks: Customer Deployment in 60-Minutes
          </p>
          <p className="underline mb-3 cursor-pointer leading-5.5 text-[#5b6063] text-sm">
            Duo MSP Tech Talks: Land and Expand
          </p>
          <p className="underline cursor-pointer leading-5.5 text-[#5b6063] text-sm">
    ...
    <div className="px-4 md:px-24 py-10">
      <div className="w-[100%] md:w-[60%]">
        ...
        <div className="text-sm">
          <p className="text-right pb-6 text-sm"> * Required</p>
...
const Better = () => {
  return (
    <div className="better px-4 md:px-24 flex flex-col justify-center">
      <div className="w-[78%] ">
        <p className="text-[2.8rem] md:text-[4.8rem] leading-18 text-white font-bold">
